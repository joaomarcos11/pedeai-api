...
public class ClienteResource {
        ...
        public Response criar(
                        @RequestBody(description = "Dados para criação do cliente", required = true, content = @Content(mediaType = "application/json", schema = @Schema(implementation = ClienteDto.class), examples = {
                                        @ExampleObject(name = "cliente", summary = "Exemplo de dados de criação do cliente", value = "{\"nome\": \"Jorge\", \"cpf\": \"12345678900\", \"email\": \"jorge@example.com\", \"ativo\": true}")
                        })) ClienteDto cliente) {
